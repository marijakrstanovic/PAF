...
class Particle():
    ...
    def __move_RK(self):
        ...
        self.k1v = ((self.q/self.m)*(self.E(self.t)+np.cross(self.v,self.B(self.t))))*self.dt
        self.k1 = self.v*self.dt

        self.k2v = ((self.q/self.m)*(self.E(self.t)+np.cross(self.v+self.k1v/2,self.B(self.t))))*self.dt
        self.k2 = (self.v + self.k1v/2)*self.dt

        self.k3v =((self.q/self.m)*(self.E(self.t)+np.cross(self.v+self.k2v/2,self.B(self.t))))*self.dt
        self.k3 = (self.v + self.k2v/2)*self.dt

        self.k4v = ((self.q/self.m)*(self.E(self.t)+np.cross(self.v+self.k3v,self.B(self.t))))* self.dt
